...
namespace Gnx.DeterministicBundle
{
    ...
    {
        private static string BundleId => Environment.GetEnvironmentVariable("GNX_RELEASE_BUNDLE_ID")
            ?? throw new InvalidOperationException("GNX_RELEASE_BUNDLE_ID is required.");
