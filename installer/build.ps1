...
$releaseProductCode = "{7E791841-74B0-4663-8993-952D43CD5C63}"
$releaseUpgradeCode = "{47D5BD44-D061-407B-913B-47D17EC3BEA9}"
$releasePackageCode = "{EC36F9AD-6477-4CA3-B40C-37CC8D4F1837}"
$releaseBundleId = "{B7AE53BF-D3A9-4948-AEC9-9C6F3490C2E2}"
$previousProductCode = "{F2F585E5-0D41-4BA5-8940-0E3AD5A86DCE}"
$previousPackageCode = "{476FA6C8-C5FB-4606-B3C0-7771ECE831C3}"
$previousBundleId = "{0392B300-F7BF-4B02-8C3E-06B5D1AF5B57}"
