...
pub(super) fn start_proxmox(podman: &Path) -> Result<(), GateError> {
...
pub(super) fn validate_proxmox_devices(podman: &Path) -> Result<(), GateError> {
...
pub(super) fn wait_for_proxmox(podman: &Path) -> Result<(), GateError> {
...
pub(super) fn proxmox_diagnostics(podman: &Path) -> String {
...
pub(super) fn confirm_empty_controller_inventory(
    podman: &Path,
...
pub(super) fn prepare_pve_identity(
    podman: &Path,
    self_ip: IpAddr,
    hostname: &str,
) -> Result<(), GateError> {
...
pub(super) fn verify_pve_identity(
    podman: &Path,
    self_ip: IpAddr,
    hostname: &str,
) -> Result<(), GateError> {
...
pub(super) fn create_controller_cluster(
    podman: &Path,
    self_ip: IpAddr,
    hostname: &str,
) -> Result<(), GateError> {
...
pub(super) fn verify_controller_cluster(
    podman: &Path,
    self_ip: IpAddr,
    hostname: &str,
) -> Result<(), GateError> {
...
pub(super) fn configure_pve_password(podman: &Path, password: &str) -> Result<(), GateError> {
