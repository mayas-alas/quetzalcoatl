...
Prioridad: validar el candidato 0.1.7 en controller y member antes de la aceptación física de tres nodos
...
Cada versión publicada obtiene un ProductCode MSI explícito y conserva el UpgradeCode `{47D5BD44-D061-407B-913B-47D17EC3BEA9}`. `MajorUpgrade` ejecuta `RemoveExistingProducts` después de `InstallInitialize`, de modo que una falla restaura la versión anterior. Quetzalcoatl 0.1.7 usa ProductCode `{129BD77D-90DE-4992-86AE-F168C930D549}`, PackageCode `{2164425B-7D79-4186-BDED-EF644CCB8804}` y Burn registration ID `{60314D27-47DF-4118-B937-6D1445BAC9D7}`. Quetzalcoatl 0.1.6 usó ProductCode `{7E791841-74B0-4663-8993-952D43CD5C63}`, PackageCode `{EC36F9AD-6477-4CA3-B40C-37CC8D4F1837}` y Burn registration ID `{B7AE53BF-D3A9-4948-AEC9-9C6F3490C2E2}`. Quetzalcoatl 0.1.5 usó ProductCode `{F2F585E5-0D41-4BA5-8940-0E3AD5A86DCE}`, PackageCode `{476FA6C8-C5FB-4606-B3C0-7771ECE831C3}` y Burn registration ID `{0392B300-F7BF-4B02-8C3E-06B5D1AF5B57}`. Quetzalcoatl 0.1.4 usó ProductCode `{EF6AC7CC-92A4-40C3-B8DA-D62845176E09}`, PackageCode `{0ED76FE6-9961-4D1A-8740-BAE336AFF777}` y Burn registration ID `{A3A9B194-9B26-4C85-A240-AAA053B8D433}`. El 0.1.3 validado históricamente usó ProductCode `{2A1C371C-EDE5-48DE-A297-1EE70F18CD1C}`, PackageCode `{4931BD41-7686-4846-96A6-DFB5F1BB0AD8}` y Burn registration ID `{6FC46C58-8F5B-44E8-90D4-9E5E90A3EC33}`; el 0.1.2 usó `{BDF28B1E-C968-4D1D-BEB1-AD110D43408F}` y el 0.1.1 `{045129E9-858F-4546-B3D8-0373EBF51D19}`. Burn conserva ProviderKey y UpgradeCode `{10B764B2-36AE-4911-A8C8-2F1A2A963769}`. La extensión de bind fijada a WiX 5.0.2 y la normalización de MSI/Burn hacen byte-reproducible el candidato; cada evidencia identifica el EXE concreto por SHA-256.
