...
use gnx_contracts::HostProfile;

use crate::domain::errors::GateError;
use crate::domain::lifecycle::Component;
use crate::infrastructure::host_profile::managed_wsl_config;
use crate::infrastructure::remote::{run_command, system_binary};
use crate::infrastructure::runtime_assets::EXPECTED_SERVICE_SID;

pub(crate) fn validate_identity() -> Result<PathBuf, GateError> {
...
pub(crate) fn configure_wsl(profile: &Path, host_profile: &HostProfile) -> Result<(), GateError> {
