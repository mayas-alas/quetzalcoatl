...
| OPERATOR-CONTROL 0.1.5 native recovery controls | architect | IN_PROGRESS | frozen 0.1.4 baseline | `gnx restart`, resumable `gnx configure forgejo`, reproducible installer |
